...
config_file="configs/parsec/x86-spec2017-ubuntu-22.py"
...
resource_build_path="${HOME}/Documents/gem5-resources/src/parsec/build-spec2017-22-04"
...
env GEM5_RESOURCE_JSON_APPEND=${resource_location} ${gem5_binary} ${gem5_params} --outdir m5out-spec2017 ${config_file} ${benchmark_params} --kernel-path ${kernel_path} --img-path ${img_path} &
